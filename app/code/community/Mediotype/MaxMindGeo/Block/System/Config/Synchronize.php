<?php
/**
 * Class Mediotype_InstantRebate_Block_System_Config_Synchronize
 *
 * @author  Joel Hart
 */
class Mediotype_MaxMindGeo_Block_System_Config_Synchronize extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /*
     * Set template
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('mediotype/geoip/config/synchronize.phtml');
    }
