 ...
 *
 */
class Mediotype_InstantRebate_Model_Geo_Database_Reader implements Mediotype_MaxMindGeo_Model_ProviderInterface
{
    private $dbReader;
    private $locales;
    ...
    public function __construct(
        ...
        $this->dbReader = new Mediotype_MaxMindGeo_Model_Reader($filename);
    ...
    private function modelFor($class, $ipAddress)
    {
        ...
        $class = "Mediotype_MaxMindGeo_Model_Locations" . $class;
//TODO assess if all classes are in locations or we need an array map here with Magento short tags
        return new $class($record, array('locales' => $this->locales));
    }
    ...
    private function getRecord($ipAddress)
    {
        ...
        if ($record === null) {
            throw new Mediotype_MaxMindGeo_Model_Exception_AddressNotFoundException(
