<?php
class Mediotype_MaxMindGeo_Model_Reader_Decoder
{
    ...
    public function decode($offset)
    {
        list(, $ctrlByte) = unpack(
            'C',
            Mediotype_MaxMindGeo_Model_Reader_Util::read($this->fileStream, $offset, 1)
        );
        $offset++;
    ...
    private function decodeByType($type, $offset, $size)
    {
        ...
        $bytes = Mediotype_MaxMindGeo_Model_Reader_Util::read($this->fileStream, $offset, $size);
        switch ($type) {
            case 'utf8_string':
    ...
    private function decodeBigUint($bytes)
    {
        ...
        $byteLength = Mediotype_MaxMindGeo_Model_Reader_Util::stringLength($bytes);
        if ($byteLength == 0) {
            return 0;
        }
    ...
    private function sizeFromCtrlByte($ctrlByte, $offset)
    {
        ...
        $bytes = Mediotype_MaxMindGeo_Model_Reader_Util::read($this->fileStream, $offset, $bytesToRead);
